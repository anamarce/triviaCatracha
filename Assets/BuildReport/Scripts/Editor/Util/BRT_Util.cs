...
public static class Util
{
	...
	public static bool IsInWinXPOS
	{
		get
		{
			return SystemInfo.operatingSystem.IndexOf("Windows XP") != -1;
		}
	}
	...
	public static string LocalAppDataPath
	{
		get
		{
			if (IsInWinXPOS)
			{
				string ret = System.Environment.GetEnvironmentVariable("USERPROFILE") + "/Local Settings/Application Data";
				ret = ret.Replace("\\", "/");
				return ret;
			}
			return System.Environment.GetEnvironmentVariable("LOCALAPPDATA").Replace("\\", "/");
		}
	}
